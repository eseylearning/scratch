...
const SBFileUploaderHOC = function (WrappedComponent) {
    class SBFileUploaderComponent extends React.Component {
        ...
        handleLinkUpload(url) {
            // const url =
            //     "https://college-test-1306428702.cos.accelerate.myqcloud.com/doc/781916443792252928.sb3";
            const {
                intl,
                isShowingWithoutId,
                loadingState,
            ...
            setTimeout(async () => {
                ...
                // Create a File object (you can specify the name and type)
            ...
            return (
                <React.Fragment>
                    <WrappedComponent
                        ...
                        onLinkUpload={this.handleLinkUpload}
                        {...componentProps}
                    />
                </React.Fragment>
            );
